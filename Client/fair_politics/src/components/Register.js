...
const gMail=()=>{
  ...
  return (
    <div>
      ...
      {!loading && (
        <div>
          <FirstRegisterFormStyle style={{ position: "relative" }}>
            ...
            <br />
            <form onSubmit={(e) => approvePassword(e)}>
          ...
          <RegisterFormStyle>
            ...
            <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-around", position: "relative", left: -20 }}>
